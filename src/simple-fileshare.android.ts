    ...
    open(args: any): void {
      if (args.path) {
        try {
          ...
          (application.android.foregroundActivity || application.android.startActivity).startActivity(android.content.Intent.createChooser(intent, args.intentTitle ? args.intentTitle : 'Open file:'));
